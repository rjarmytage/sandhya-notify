...
**Location.** Sandhya uses your device's location solely to calculate the times
of sunrise, sunset, and true solar noon at your current position, so it can show
you and notify you about the three daily sandhya windows. If you choose Automatic
location mode, the app also uses location updates to keep these times accurate
...
- Your location is **never used to track you**, to build a profile of you, or
  shared with any advertiser, analytics provider, or other third party.
- The app contains no advertising and no third-party SDKs.
